...
readme_content = '''# Garden Paradise - Plant Shop
...
print("2. plants_data.json - Plant inventory (12 plants)")
print("3. coupons.json - Coupon codes (5 coupons)")
print("4. requirements.txt - Dependencies")
print("5. README.md - Instructions and documentation")